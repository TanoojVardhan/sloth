          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">Find quick answers to common questions about using Sloth Planner.</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">Step-by-step guides and detailed documentation.</p>
                <Button asChild variant="outline" className="mt-2">
